...
import org.k8s.tekton.v1.*;
import org.k8s.tekton.v1.task.V1TaskRef;
import org.k8s.tekton.v1.task.V1TaskResult;
...
public class V1PipelineTask {
    ...
    private V1WhenExpressions<?> when;
    ...
    private List<V1RunParam<?>> matrix;
